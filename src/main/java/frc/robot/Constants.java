...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final double kDrivingMotorFreeSpeedRps = CIMMotorConstants.kFreeSpeedRpm / 60;
    public static final double kWheelDiameterMeters = 0.1524;
    public static final double kWheelCircumferenceMeters = kWheelDiameterMeters * Math.PI;
    public static final double kDrivingMotorReduction = 8.45; // this reduction was from the AndyMark site ?
  ...
  public static final class CIMMotorConstants {
    public static final double kFreeSpeedRpm = 5310;
  }
}
